...
def handshake(CLIENT1, CLIENT2, CLIENT3, OPCODE1, OPCODE2, POSTFIX):
    #Own mac address
...
#####
        ...
        time_elapsed = int(dragonfly_time - start)
...
#####
    ...
    time_elapsed1 = int(stop - dragonfly_time)
    time_elapsed2 = int(stop - start)
...
own_ipaddr = '192.168.0.4'
own_address_kg = (own_ipaddr, 7000)
