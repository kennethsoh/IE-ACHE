...
int main() {
	...
	*/
    ...
    printf("Hi there! The number (1111) will be sent to CLOUD in an encrypted state for calculation.\n");
    ...
    FILE* cloud_data = fopen("cloud1.data","wb");
    for (int i=0; i<32; i++)
