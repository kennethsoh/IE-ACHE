...
int main() {
	...
	*/
    ...
    printf("Hi there! The number (3333) will be sent to CLOUD in an encrypted state for calculation.\n");
    ...
    FILE* cloud_data = fopen("cloud3.data","wb");
    for (int i=0; i<32; i++)
